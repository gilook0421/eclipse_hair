...
public class ExcelRead {
	...
	private static final Logger logger = LoggerFactory.getLogger(ExcelRead.class);
     ...
     public static List<Map<String, String>> read(ExcelReadOption excelReadOption) {
            ...
            if(logger.isDebugEnabled()) logger.debug("Sheet 이름: "+ wb.getSheetName(0)); 
            if(logger.isDebugEnabled()) logger.debug("데이터가 있는 Sheet의 수 :" + wb.getNumberOfSheets());
            /**
...
//                if(logger.isDebugEnabled()) logger.debug(map.get("A"));
//            }
//        }
