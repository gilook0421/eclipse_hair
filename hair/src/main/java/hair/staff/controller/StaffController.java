...
import hair.staff.service.StaffService;
...
public class StaffController {
	...
	// 리스트 뷰
	@RequestMapping(value="/staffListView.api", method=RequestMethod.GET)
	...
	// 글쓰기
	@ResponseBody
	@RequestMapping(value="/staffWrite.api", method=RequestMethod.POST)
	...
	// 리스트
	@ResponseBody
	@RequestMapping(value="/staffList.api", method=RequestMethod.POST)
