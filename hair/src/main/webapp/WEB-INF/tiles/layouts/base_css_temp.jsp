...
<body style="padding: 50px;background-color: black;">
	...
	<div style="width:100%; height:100%;">
	    <div id="content">
	    	<div id="header" class="logo" style="border: 1px solid yellow;"><tiles:insertAttribute name="header" /></div>
	    	<div id="menu" style="border: 1px solid yellow; height: 30px;"><tiles:insertAttribute name="menu" /></div>
	    	<div id="comm" style="border: 1px solid yellow; height: 30px;"><tiles:insertAttribute name="comm" /></div>
	    	<div id="body" style="border: 1px solid yellow;"><tiles:insertAttribute name="body" /></div>
	    	<div id="footer" class="footer" style="border: 1px solid yellow;"><tiles:insertAttribute name="footer" /></div>
	    </div>    
